...
const ManageSkills = () => {
  ...
  const handleInputChange = (id, proficiency) => {
    // Ensure the proficiency value is between 50 and 100
    const validProficiency = Math.max(50, Math.min(100, Number(proficiency)));
    setProficiencyValues((prevState) => ({
      ...prevState,
      [id]: validProficiency,
    }));
  };
  ...
  const handleUpdateSkill = (id) => {
    const proficiency = proficiencyValues[id];
    if (proficiency) {
                ...
                return (
                  <Card key={element._id}>
                    ...
                    <CardFooter>
                      ...
                      <Input
                        type="number"
                        value={proficiencyValues[element._id] || element.proficiency}
