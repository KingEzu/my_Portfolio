...
const AddApplication = () => {
  ...
  const handleSvg = (e) => {
    const file = e.target.files[0];
      // Check for file size (limit of 10MB)
  ...
  if (file && !validTypes.includes(file.type)) {
    toast.error("Invalid file type. Only PNG, JPG, or GIF are allowed.");
    return;
  }
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div className="text-center">
                      ...
                      <div className="mt-4 flex text-sm leading-6 text-gray-600">
                        <Label
                          htmlFor="file-upload"
                          className="relative cursor-pointer rounded-md bg-transparent font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500 underline "
                        >
                          ...
                          <Input
                            ...
                            type="file"
                            className="sr-only"
                            accept="image/png, image/jpeg, image/gif" // Only allow PNG, JPG, GIF files
                            onChange={handleSvg}
                          />
